    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6" data-aos="fade-right">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-8">Welkom op mijn Portfolio</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                    Ik wil websites en apps maken die niet alleen goed werken, maar ook fijn zijn om te gebruiken. 
                    Ik vind het leuk om nieuwe dingen te leren en blijf mezelf steeds verbeteren met nieuwe technieken.
                </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8" data-aos="fade-left">
                <!-- Project Stats -->
                <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                            </svg>
                        </div>
                        <span class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent">8+</span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Projecten</h3>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Afgeronde projecten in verschillende technieken</p>
                </div>

                <!-- Experience Stats -->
                <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-indigo-100 dark:bg-indigo-900 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                        </div>
                        <span class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-400 dark:from-indigo-400 dark:to-indigo-300 bg-clip-text text-transparent">4+</span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Jaar Ervaring</h3>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">In software & web development, inclusief stages en bijbanen</p>
                </div>

                <!-- Technologies Stats -->
                <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/>
                            </svg>
                        </div>
                        <span class="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-400 dark:from-purple-400 dark:to-purple-300 bg-clip-text text-transparent">6+</span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Technologieën</h3>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Verschillende programmeertalen en frameworks</p>
                </div>

                <!-- Education Stats -->
                <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-yellow-100 dark:bg-yellow-900 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
                        ...
                        <span class="text-3xl font-bold bg-gradient-to-r from-yellow-600 to-yellow-400 dark:from-yellow-400 dark:to-yellow-300 bg-clip-text text-transparent">2</span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Stages</h3>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Afgeronde en huidige stages</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="highlights" class="py-20 px-4 bg-white dark:bg-gray-800 relative">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" 
...
<section class="py-20 px-4 bg-white dark:bg-gray-800">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Modern Development -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" data-aos="fade-up">
                <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-6">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Moderne Ontwikkeling</h3>
            ...
            <!-- Soft Skills -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Soft Skills</h3>
                <ul class="space-y-3 text-gray-600 dark:text-gray-300">
                    <li class="flex items-start">
            ...
            <!-- Groei & Ontwikkeling -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mb-6">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Groei & Ontwikkeling</h3>
                <ul class="space-y-3 text-gray-600 dark:text-gray-300">
                    <li class="flex items-start">
        ...
        <!-- Extra Info -->
        <div class="mt-16 bg-blue-50 dark:bg-gray-700/50 rounded-2xl p-8" data-aos="fade-up">
...
<section class="py-20 px-4 bg-white dark:bg-gray-800">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <!-- Frontend Skills -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Frontend</h3>
                <div class="space-y-3">
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">HTML/CSS</span>
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Tailwind CSS</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">85%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
                            <div class="h-full bg-blue-600 rounded" style="width: 85%"></div>
            ...
            <!-- Backend Skills -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
                <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Backend</h3>
                <div class="space-y-3">
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">MySQL</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">75%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
            ...
            <!-- CMS & Tools -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
                <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">CMS & Tools</h3>
                <div class="space-y-3">
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">WordPress</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">90%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
                            <div class="h-full bg-blue-600 rounded" style="width: 90%"></div>
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Git</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">85%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
                            <div class="h-full bg-blue-600 rounded" style="width: 85%"></div>
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Docker</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">70%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
            ...
            <!-- Additional Skills -->
            <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="400">
                <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Extra Skills</h3>
                <div class="space-y-3">
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">TypeScript</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">75%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
                            <div class="h-full bg-blue-600 rounded" style="width: 75%"></div>
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">C#</span>
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-400">70%</span>
                        </div>
                        <div class="overflow-hidden h-2 bg-gray-200 rounded">
                            <div class="h-full bg-blue-600 rounded" style="width: 70%"></div>
                    ...
                    <div class="relative pt-1">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">ASP.NET</span>
            ...
            <div class="space-y-12">
                <div class="relative" data-aos="fade-right">
                    <div class="flex items-center">
                        <div class="flex-1 text-right pr-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Stage bij Developing B.V.</h3>
                            <p class="text-gray-600 dark:text-gray-300">sep. 2024 - heden</p>
                ...
                <div class="relative" data-aos="fade-left">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 pl-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Service Employee bij Pathé</h3>
                            <p class="text-gray-600 dark:text-gray-300">mei 2023 - heden</p>
                            <p class="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <div class="relative" data-aos="fade-left">
                    <div class="flex items-center">
                        ...
                        <div class="w-4 h-4 bg-blue-600 rounded-full border-4 border-white shadow"></div>
                        <div class="flex-1 pl-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Stage bij I@control</h3>
                            <p class="text-gray-600 dark:text-gray-300">feb. 2023 - apr. 2023</p>
                            <p class="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <div class="relative" data-aos="fade-right">
                    <div class="flex items-center">
                        <div class="flex-1 text-right pr-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Verkoopmedewerker bij Action</h3>
                            <p class="text-gray-600 dark:text-gray-300">okt. 2020 - mei 2023</p>
                            <p class="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <div class="relative" data-aos="fade-left">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 pl-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Software Development Opleiding</h3>
                            <p class="text-gray-600 dark:text-gray-300">Rijn IJssel</p>
                            <p class="text-gray-600 dark:text-gray-300">2021 - 2024</p>
                            <p class="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <div class="relative" data-aos="fade-right">
                    <div class="flex items-center">
                        <div class="flex-1 text-right pr-8">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">MAVO</h3>
                            <p class="text-gray-600 dark:text-gray-300">Pallas Athene College</p>
                            <p class="text-gray-600 dark:text-gray-300">2017 - 2021</p>
                        </div>
                        <div class="w-4 h-4 bg-indigo-600 rounded-full border-4 border-white shadow"></div>
                        <div class="flex-1"></div>
                    </div>
...
<section class="py-20 px-4 bg-white dark:bg-gray-800">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Testimonial 1 -->
            <div class="bg-white dark:bg-gray-700 rounded-xl shadow-lg p-8 relative" data-aos="fade-up">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Sven van den Berg</p>
                        <p class="text-sm text-gray-500 dark:text-gray-300">Stage Begeleider, Developing B.V.</p>
                    </div>
                </div>
            </div>

            <!-- Testimonial 2 -->
            <div class="bg-white dark:bg-gray-700 rounded-xl shadow-lg p-8 relative" data-aos="fade-up" data-aos-delay="100">
                <div class="absolute top-0 right-0 transform -translate-y-1/2 translate-x-1/2">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Mark Timmer</p>
                        <p class="text-sm text-gray-500 dark:text-gray-300">Senior Developer, Developing B.V.</p>
                    </div>
                </div>
            </div>

            <!-- Testimonial 3 -->
            <div class="bg-white dark:bg-gray-700 rounded-xl shadow-lg p-8 relative" data-aos="fade-up" data-aos-delay="200">
                <div class="absolute top-0 right-0 transform -translate-y-1/2 translate-x-1/2">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Kristian Huisman</p>
                        <p class="text-sm text-gray-500 dark:text-gray-300">Lead Developer, Developing B.V.</p>
                    </div>
                </div>
            </div>
        </div>
